...
```{r}
#group arrival and departure time by hour
...
```{r}
write.csv(flightsDB, "flightsDB.csv")
```

```{r}
flightsDB <- read.csv("flightsDB.csv")
...
```{r}
test <- read.csv("/Users/chrishilger/Downloads/Flight_Data/newfile.csv")
```
